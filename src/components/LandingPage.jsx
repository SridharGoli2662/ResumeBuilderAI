      ...
      <DemoPiece>
       <div className="left">   
        <div>
            ...
            <h5>Start building your future today with our AI-driven approach!</h5>
            ...
            <TypeAnimation
             sequence={[
                ...
                2000,                          // Pause for 2 seconds
                'Craft Your Resume Based on Job Description',2000,
          ...
          <h4>Don't Worry We Are Here to Help You</h4>
           <h2>Carft your Ai Resume</h2> */}
            ...
            <Link to={"/ResumeEdit"}>
              <button className="px-5 py-2.5 text-lg font-medium text-white bg-orange-600 hover:bg-orange-800 focus:ring-4 focus:outline-none focus:ring-orange-300 w-60 rounded-lg text-center">GetStarted</button>
            </Link>
          </div>
          </div>
...
const DemoPiece = styled.div`
  margin: 6rem auto;
  h1{
    background-image: linear-gradient(43deg, #f40d0d 0%, #b63aae
46%, #FFCC70 100%);
